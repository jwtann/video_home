<template>
    <div>
        ...
        <swiper :options="swiperOption">
            <swiper-slide v-for="v in sliders" :key="v.id"><img :src="v.slider" alt=""></swiper-slide>
        ...
        <div class="today">
            <a href="javascript:;" class="title">Facebook数据再次外泄</a>
            <p class="column">最新资讯</p>
            <div class="pic">
                <a href="javascript:;" v-for="v in hiddenSliders"><img :src="v.slider"/></a>
            </div>
        </div>
        <!--今日话题结束-->
...
<script>
    ...
    export default {
        ...
        methods:{
            getSliders(){
                Vue.axios.get('http://video.jwtan.cn/getSliders').then((response) => {
                    // console.log(response.data);
                    this.sliders = response.data;
                })
            },
            getCommendLessons(){
                Vue.axios.get('http://video.jwtan.cn/getCommendLessons/4').then((response) => {
                    // console.log(response.data);
            ...
            getHiddenSliders(){
                Vue.axios.get('http://video.jwtan.cn/getHiddenSliders').then((response) => {
                    // console.log(response.data);
                    this.hiddenSliders = response.data;
                })
            },
        },
        mounted(){
