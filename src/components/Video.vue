<template>
    <div>
        ...
        <swiper :options="swiperOption">
            <swiper-slide>
                <span @click="getTagLessons(0)">全部视频</span>
            </swiper-slide>
        ...
        <!--视频列表-->
        <ul id="videolist">
            <li v-for="v in allLessons" :key="v.id">
...
<script>
    ...
    export default {
        ...
        methods:{
            getTags(){
                Vue.axios.get('http://video.jwtan.cn/getTags').then((response) => {
                    // console.log(response.data);
                    this.tags = response.data;
                })
            },
            getAllLessons(){
                Vue.axios.get('http://video.jwtan.cn/getAllLessons').then((response) => {
                    // console.log(response.data);
                    this.allLessons = response.data;
                })
            },
            getTagLessons(id){
                Vue.axios.get('http://video.jwtan.cn/getTagLessons/'+id).then((response) => {
                    // console.log(response.data);
                    this.allLessons = response.data;
                })
            }
